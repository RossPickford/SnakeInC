...
This outlines how the UI elements are initialised in this project
...
A UI Element Group is not a struct or variable, but rather a pointer to a chunk of memory allocated in the arena the size of
