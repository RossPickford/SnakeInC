...
bool ChangeButtonState(TextButton *btnData, E_ButtonState state)
{
 ...
 */
void AssignButtonData(TextButton *btn, SDL_Color display, SDL_Color highlight, SDL_Color select, E_ButtonState curState, E_ButtonState prevState)
{
