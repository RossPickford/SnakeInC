...
gcc -c ui_types.c -o ui_types.o -I "./external/SDL/include" -I "./external/SDL_ttf/include"
gcc -c mainMenuLayout.c -o mainMenuLayout.o -I "./external/SDL/include" -I "./external/SDL_ttf/include"
gcc  ui_types.o arena.o mainMenuLayout.o ui_editor.o test_editor_main.o -o test_editor.exe -L "external/SDL_ttf/lib" -L "./external/SDL/lib" -lSDL3_ttf -lSDL3
